...
import type { EIP712Domain, EIP712Type } from "./types";
...
export async function signTypedData(
	...
	try {
		// @ts-expect-error - _signTypedData exists in v5
...
export function encodeTypedData(
	...
	return ethers.utils._TypedDataEncoder.encode(domain, types as any, value);
}
...
export function getTypedDataHash(
	...
	return ethers.utils._TypedDataEncoder.hash(domain, types as any, value);
}
