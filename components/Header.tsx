...
const Icons = {
	...
	Rewards: () => (
		<svg viewBox="0 0 24 24">
			<path d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5a2 2 0 10-2 2h2zm0 0h3a2 2 0 110 4h-3m0-4h-3a2 2 0 100 4h3m0 0v10" />
		</svg>
	),
	Contact: () => (
		<svg viewBox="0 0 24 24">
				...
				<nav>
					{navItems.map((item) => (
						<NavLink
							key={item.href}
							href={item.href}
							$active={pathname === item.href || activePage === item.href}
						>
							<item.Icon /> {item.name}
						</NavLink>
					))}
