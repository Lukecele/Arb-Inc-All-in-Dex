    ...
    for (let wallet of seedWallets) {
        try {
            ...
            if (addr === PARTNER_WALLET) {
                finalScore += 1000;
                console.log(`💎 PARTNER: ${addr} | Balance: ${balance.toFixed(2)} | Bonus +1000 applicato.`);
            }
            ...
            console.log(`✅ ${addr}: Balance ${balance.toFixed(0)} -> Punti: ${finalScore}`);
