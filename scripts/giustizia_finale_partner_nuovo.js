...
async function run() {
    ...
    const PARTNER_WALLET = "0x74a8ea4126d0e099eb6a50d508e9be6d24d345cc".toLowerCase();
    ...
    for (let wallet of seedWallets) {
        try {
            ...
            if (addr === PARTNER_WALLET) {
                ...
                finalScore = 1000;
                console.log(`💎 PARTNER IDENTIFICATO: ${addr} -> 1000 Bonus (No holding points)`);
            } else {
                ...
                if (addr === "0x510f4dcbe2063f95d64f25816a6fb27f0c6a255d") finalScore += 250;

                console.log(`✅ HOLDER: ${addr} -> Punti: ${finalScore} (Holding: ${balance.toFixed(0)})`);
            }

            // Scriviamo su Redis
            await redis.zadd('leaderboard:points', { score: finalScore, member: addr });
