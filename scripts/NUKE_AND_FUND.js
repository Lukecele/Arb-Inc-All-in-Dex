...
async function nukeAndFund() {
    ...
    await redis.set('leaderboard:total_points_sum:global', totalPoints.toString());

    // Assegniamo gli 0.008601 BNB reali (con SAFE_FACTOR 80%)
    const REAL_BNB = 0.008601;
    const CORRECT_INDEX = (REAL_BNB * 0.80) / totalPoints;
    ...
    console.log("✅ OPERAZIONE COMPLETATA! Database immacolato e fondi caricati.");
    process.exit(0);
}
nukeAndFund();
