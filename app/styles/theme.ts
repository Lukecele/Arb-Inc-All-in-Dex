...
export const theme = {
	...
	shadows: {
		...
		glowStrong:
			"0 0 40px rgba(124, 58, 237, 0.5), 0 0 100px rgba(124, 58, 237, 0.2)",
		glowCyan:
			"0 0 25px rgba(6, 182, 212, 0.3), 0 0 60px rgba(6, 182, 212, 0.1)",
		glowGold:
			"0 0 20px rgba(245, 158, 11, 0.35), 0 0 60px rgba(245, 158, 11, 0.1)",
