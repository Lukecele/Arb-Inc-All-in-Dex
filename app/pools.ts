...
export const pools: PoolInfo[] = [
  ...
  },
  {
    id: 'arb-inc-more',
    name: 'Arb Inc / MORE',
    address: '0x6ADf2c67a86b49B20b07532620fA88B3c8575Ae1',
    token0: {
      symbol: 'Arb Inc',
      address: ARB_INC_ADDRESS,
      decimals: 9,
  ...
  },
  {
    id: 'arb-inc-lab',
    name: 'Arb Inc / LAB',
    address: '0xd40f6fedFB7Fe91d615E9333BC317f8f158f12c8',
    token0: {
      symbol: 'Arb Inc',
      address: ARB_INC_ADDRESS,
      decimals: 9,
  ...
  },
  {
    id: 'arb-inc-e',
    name: 'Arb Inc / E',
    address: '0xA3d23AE6d3282094Fa5DC972EABBb4bD0Cc238c1',
    token0: {
      symbol: 'Arb Inc',
      address: ARB_INC_ADDRESS,
      decimals: 9,
    ...
    token1: {
      symbol: 'E',
      address: '0x758309C0d1342e0D5A778B83cdcEBAa3F4554444',
      decimals: 18,
    },
    poolType: 'DEX_PANCAKESWAPV2',
    liquidityUSD: 120,
  ...
  },
  {
    id: 'arb-inc-nb',
    name: 'Arb Inc / NB',
    address: '0x7959c1e4D1AD2B0b99D92547CFC431830509F391',
    token0: {
      symbol: 'Arb Inc',
      address: ARB_INC_ADDRESS,
      decimals: 9,
    ...
    token1: {
      symbol: 'NB',
      address: '0xc2bD425A63800731E3Ae42b6596BDD783299fCb1',
      decimals: 18,
    },
    poolType: 'DEX_PANCAKESWAPV2',
    liquidityUSD: 100,
  ...
  },
  {
    id: 'arb-inc-vertex',
    name: 'Arb Inc / VERTEX',
    address: '0x24A1E189FEB48681880B477DB27529Db7087f2D4',
    token0: {
      symbol: 'Arb Inc',
      address: ARB_INC_ADDRESS,
      decimals: 9,
    ...
    token1: {
      symbol: 'VERTEX',
      address: '0x167315BE60CaAfDe69183D35b3f1501EA5677777',
      decimals: 18,
    },
    poolType: 'DEX_PANCAKESWAPV2',
    liquidityUSD: 373.59,
  ...
  },
  {
    id: 'arb-inc-shih',
    name: 'Arb Inc / Shih',
    address: '0xAb517c7e4094fe27e35eCEDb173Bd34485F80483',
    token0: {
      symbol: 'Arb Inc',
      address: ARB_INC_ADDRESS,
      decimals: 9,
    ...
    token1: {
      symbol: 'Shih',
      address: '0xfCa5208e4074e06596CC28B47214A109E4c14444',
      decimals: 18,
    },
    poolType: 'DEX_PANCAKESWAPV2',
    liquidityUSD: 471.98,
  ...
  },
  {
    id: 'arb-inc-bocz',
    name: 'Arb Inc / BOCZ',
    address: '0xb7a7570d9e7cd36f4A0d2Cb9cC7bD1f0D1FB8e91',
    token0: {
      symbol: 'Arb Inc',
      address: ARB_INC_ADDRESS,
      decimals: 9,
    ...
    token1: {
      symbol: 'BOCZ',
      address: '0x701bE97c604A35aB7BCF6C75cA6de3aba0704444',
      decimals: 18,
    },
    poolType: 'DEX_PANCAKESWAPV2',
    liquidityUSD: 283.46,
  ...
  },
  {
    id: 'arb-inc-share',
    name: 'Arb Inc / SHARE',
    address: '0xFd7042d3B01Ba7C6D76ABa8E85D952bA799932aD',
    token0: {
      symbol: 'Arb Inc',
      address: ARB_INC_ADDRESS,
      decimals: 9,
  ...
  },
  {
    id: 'arb-inc-4',
    name: 'Arb Inc / 4',
    address: '0x089C5363D734745fe130267EC3262f37CC33997e',
    token0: {
      symbol: 'Arb Inc',
      address: ARB_INC_ADDRESS,
      decimals: 9,
  ...
  },
  {
    id: 'arb-inc-zswap',
    name: 'Arb Inc / ZSWAP',
    address: '0xC13d9DD9d5ae31D92DDe9fA0A6890F1be6835650',
    token0: {
      symbol: 'Arb Inc',
      address: ARB_INC_ADDRESS,
      decimals: 9,
    ...
    token1: {
      symbol: 'ZSWAP',
      address: '0x2e44aB95549b8a12AFDB970bde5A6a78365e4444',
      decimals: 18,
    },
    poolType: 'DEX_PANCAKESWAPV2',
    liquidityUSD: 386.48,
  ...
  },
  {
    id: 'arb-inc-ensoul',
    name: 'Arb Inc / Ensoul',
    address: '0xeC9b43E098b42F82Edb54Fa563899A5f906e266e',
    token0: {
      symbol: 'Arb Inc',
      address: ARB_INC_ADDRESS,
      decimals: 9,
