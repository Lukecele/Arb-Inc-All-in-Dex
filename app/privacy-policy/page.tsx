      ...
      <Container>
        ...
        <MainContent>
          ...
          <p className="last-updated">
            Last Updated: May 6, 2026 — pursuant to Art. 13 Reg. EU 2016/679 (GDPR)
            and D.Lgs. 196/2003 as amended by D.Lgs. 101/2018
          </p>

          <h2>1. Data Controller</h2>
          <p>
            This platform is operated by <strong>Arbitrage Inception</strong>, an anonymous,
            community-driven open-source project (MIT License) with no registered legal entity.
            For privacy-related requests, reach us via:{' '}
            <a href="https://t.me/ArbitrageInception" target="_blank" rel="noopener noreferrer">Telegram</a>{' '}
            or{' '}
            <a href="https://github.com/Lukecele/Arb-Inc-All-in-Dex/issues" target="_blank" rel="noopener noreferrer">GitHub Issues</a>.
            We will respond within 30 days as required by Art. 12 GDPR.
          </p>
          <p>
            No Data Protection Officer (DPO) has been appointed as the processing does not fall
            within the mandatory cases under Art. 37 GDPR.
          </p>

          <h2>2. Data Processed, Purposes, and Legal Bases</h2>

          <h3>2.1 Technical Navigation Data</h3>
          <p>Systems automatically collect data implicit in internet communications:</p>
          <ul>
          ...
          <p><strong>Legal basis:</strong> Legitimate interest (Art. 6(1)(f) GDPR) — platform security and functionality.</p>
          <p><strong>Retention:</strong> Maximum 12 months, unless required by law.</p>

          <h3>2.2 Blockchain Wallet Address</h3>
          <p>
            When you connect a crypto wallet, the public address becomes visible to the interface.
            Wallet addresses are publicly available on-chain. We process this data solely to enable
            the service you requested.
          </p>
          <p><strong>Legal basis:</strong> Performance of requested service (Art. 6(1)(b) GDPR).</p>
          ...
          <p><strong>Legal basis:</strong> Consent (Art. 6(1)(a) GDPR) — obtained via cookie banner.</p>
          <p>
            <strong>Extra-EU transfer:</strong> Google LLC (USA) — covered by Standard Contractual Clauses (SCC) per EU Commission Decision 2021/914.{' '}
            <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer">Opt-out here</a>.
          </p>

          <h2>3. What We Do NOT Collect</h2>
          <p>
            We do not store private keys, seed phrases, or wallet passwords. All transactions
            are executed directly on-chain via the user&apos;s own wallet. No party associated
            with this project has access to user funds.
          </p>

          <h2>4. Data Sharing</h2>
          <p>Personal data is not sold or transferred to third parties for commercial purposes. Data may be shared with:</p>
          <ul>
            <li>Technical service providers (hosting, CDN) to the extent strictly necessary</li>
          ...
          <ul>
            ...
            <li><strong>Erasure / Right to be Forgotten (Art. 17)</strong></li>
            <li><strong>Restriction of Processing (Art. 18)</strong></li>
            <li><strong>Data Portability (Art. 20)</strong></li>
            <li><strong>Objection (Art. 21):</strong> Object to processing based on legitimate interest</li>
            <li><strong>Withdrawal of Consent:</strong> Withdraw at any time without prejudice to prior lawful processing</li>
          </ul>
          <p>
          ...
          <p>
            ...
            from minors. Contact us immediately if you believe a minor has provided data.
          </p>

          <h2>9. Policy Updates</h2>
          <p>
            Significant changes will be announced via the GitHub repository with at least
            30 days notice. The current version is always available at this address.
          </p>

          <h2>10. Contact</h2>
          <p>
            Privacy questions:{' '}
            <a href="https://t.me/ArbitrageInception" target="_blank" rel="noopener noreferrer">Telegram Community</a>{' '}
            or{' '}
            <a href="https://github.com/Lukecele/Arb-Inc-All-in-Dex/issues" target="_blank" rel="noopener noreferrer">GitHub Issues</a>.
          </p>
        </MainContent>
