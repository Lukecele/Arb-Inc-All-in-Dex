...
export const metadata: Metadata = {
	...
	description:
		"Bridge tokens across 20+ chains with the best rates. Powered by Mayan Finance for fast, low-cost cross-chain swaps from/to BNB Smart Chain.",
	keywords: [
		"DeFi",
		"Bridge",
		"Cross-chain",
	...
	openGraph: {
		title: "Bridge | Cross-Chain Token Swaps | Arbitrage Inception",
		description:
			"Bridge tokens across 20+ chains with the best rates. Powered by Mayan Finance.",
