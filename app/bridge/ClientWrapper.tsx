...
function handleWidgetReady() {
	if (typeof window !== "undefined" && window.MayanSwap) {
		window.MayanSwap.init(
			"mayan_widget",
			mayanConfig as Record<string, unknown>,
		);
	}
}
			...
			<div style={{ padding: "24px 16px" }}>
				<div style={{ maxWidth: 620, margin: "0 auto", textAlign: "center" }}>
					...
					<p style={{ color: "#a1a1aa", fontSize: 16, marginBottom: 24 }}>
						Powered by{" "}
						<strong style={{ color: "#8B5CF6" }}>Mayan Finance</strong>
					</p>
					...
					>
						...
						/>
						Bridge tokens across{" "}
						<strong style={{ color: "#fff" }}>Solana ↔ BNB Chain</strong> and
						other major networks with best-rate routing. Powered by{" "}
						<strong style={{ color: "#8B5CF6" }}>Mayan Finance</strong> — fast,
						secure, and optimised for Solana cross-chain swaps.
						<br />
						<br />
						Supported chains: Solana, BNB Chain, Ethereum, Arbitrum, Polygon,
						Base, Avalanche, and more.
					</div>
