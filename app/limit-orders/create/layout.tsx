...
export const metadata: Metadata = {
	...
	description:
		"Create a limit order on BNB Smart Chain. Set your desired price and trade automatically when the market reaches your target. Powered by KyberSwap aggregator.",
	keywords: [
		"create limit order",
		"set price",
		"limit order BSC",
	...
	openGraph: {
		...
		description:
			"Set your desired price and trade automatically when the market reaches your target. Powered by KyberSwap.",
	...
	twitter: {
		...
		title: "Create Limit Order | Arbitrage Inception",
		description:
			"Set your desired price and trade automatically when the market reaches your target.",
		images: ["/og-image.png"],
