...
export default function RewardsClient() {
	...
	const referralLink = address
		? `${window.location.origin}/rewards?ref=${address}`
		: "";
		...
		>
			...
			>
				...
				>
					...
					>
						<div
							style={{ fontSize: "18px", fontWeight: "bold", color: "#818cf8" }}
						>
							{referralCount}
						</div>
						<div
          ...
          <p style={{ color: "#94a3b8", fontSize: "11px", marginTop: "6px", fontStyle: "italic" }}>* Annualized estimate: 12h fee cycle ÷ proportional token stake. Past performance does not guarantee future results. Risk of total or partial loss.</p>
