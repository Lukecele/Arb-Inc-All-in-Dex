...
const FEE_RECEIVER = "0x66BB01F14229E2179bAD84D52A69C0e4628dE63f";
const FEE_PCM = 10;
				...
				<Container>
					<div style={{ textAlign: "center", marginBottom: "30px" }}>
						...
						<p style={{ color: "#94a3b8", maxWidth: "600px" }}>
							Aggregated liquidity from 100+ DEXes for the best possible rates
							on BSC.
						</p>
					</div>
					...
					<SwapWrapper>
						...
						<ContractBox>
							<span className="addr">
								ARB Inc: {ARB_CONTRACT.slice(0, 10)}...
							</span>
