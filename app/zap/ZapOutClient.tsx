	...
	return (
		<Container>
			<Card>
				...
				<Description>
					View and manage your liquidity positions on PancakeSwap. Select your{" "}
					{token0Symbol}/{token1Symbol} position to remove liquidity.
				</Description>
				...
				<p style={{ marginTop: "20px", color: "#666", fontSize: "14px" }}>
					You will be redirected to PancakeSwap's official interface to manage
