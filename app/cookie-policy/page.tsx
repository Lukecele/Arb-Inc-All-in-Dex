		...
		<>
			...
			<Container>
				<Header>
					<LogoSection>
						<Logo
							src="https://arbitrage-inc.exchange/logo.jpg"
				...
				<MainContent>
					...
					<p>
						We use cookies on https://arbitrage-inc.exchange for the following
						purposes:
					</p>
					<ul>
						<li>
							...
							functionality such as security, network management, and wallet
					...
					<p>
						<strong>3.1 Strictly Necessary Cookies</strong>
					</p>
					<p>
						These cookies are essential for you to browse the website and use
						its features, such as accessing secure areas. Consent is not
						required for these cookies.
					</p>
					<ul>
					...
					<p>
						These cookies allow our website to remember choices you have made in
						the past.
					</p>
					<ul>
					...
					<p>
						...
						pages. We do not control these third-party cookies. You can block
						them by updating your browser settings or using third-party opt-out
						tools.
					</p>
					...
					<p>
						...
						to set cookies, you may impact your overall user experience.
					</p>
					...
					<p>
						Cookies are retained for different periods depending on their
						purpose:
					</p>
					<ul>
						<li>
						...
						<li>
							...
							you delete them (typically 1-24 months)
						</li>
					</ul>
					...
					<p>
						...
						us at our{" "}
						<a href="/contact" style={{ color: "#28E0B9" }}>
							Contact Page
						</a>
						.
					</p>
				...
				<Footer>
					...
					<Disclaimer>
						...
						high risk. Arbitrage Inception provides a frontend interface powered
						by KyberSwap Protocol and is not responsible for any financial
						losses. Please trade responsibly.
					</Disclaimer>
					<p>
						Powered by KyberSwap Protocol. Arbitrage Inception provides a
						customized interface to access decentralized liquidity pools on the
						BNB Smart Chain.
					</p>
